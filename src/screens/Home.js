    ...
    <View style={styles.container}>
      <LinearGradient start={{ x: 1.5, y: 0.0 }} end={{ x: 1.2, y: .9 }}
        ...
        <ScrollView>
          ...
          {/* search end */}
          {/* trending this week bein */}
          <View style={styles.trending}>
            <Text style={styles.trendingLeft}>Trending This Week</Text>
            {/* left side */}
            <TouchableOpacity style={styles.trendingRight}>
              <Text style={styles.trendingRightViewAll}>View All</Text>
              <Ionicons name="chevron-forward-outline" size={18} color={'#ea1788'} />
            </TouchableOpacity>
          </View>
          {/* Slide begin */}
          <ScrollView horizontal style={styles.slide}>
            {slideItems.map((_item) => (
              <HomeSlide data={_item} />
            ))}
          </ScrollView>
          {/* Slide end */}
          {/* categories begin */}
          <View style={styles.categories}>
            ...
            <FlatList
              numColumns={4}
              data={catItems}
              renderItem={(value) => <Categories item={value.item} navigate={props.navigation.navigate} />}
